...
class HBNBCommand(cmd.Cmd):
    ...
    def my_errors(self, line, num_of_args):
        ...
        Description:
            Displays output to the user based on
            the input commands.
        ...
        if num_of_args >= 1 and args[0] not in classes:
            ...
            return 0
        if num_of_args >= 2 and leg(args) < 2:
            print(msg[2])
            return 1
        d = storage.all()
    ...
    def do_EOF(self, line):
        ...
        Args:
            line(args): input argument for quitting the terminal
    ...
    def do_create(self, line):
        ...
        of that class updates 'updated_at' attribute, and 
